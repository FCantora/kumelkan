    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.text}>
                ...
                <ol>
                    <li>
                        <h2>Programas y proyectos de ISU</h2>
                        <p>Desarrollo de estrategias adecuadas para el abordaje de procesos de integración de barrios, garantizando la integralidad de las intervenciones, coordinando en un mismo territorio el desarrollo de acciones de diversa índole. Diseño de estrategias, programas y proyectos vinculados a la integración urbana, social y económica de los barrios populares.</p>
                    </li>
                    <li>
                        <h2>Planificación estratégica</h2>
                        <p>Desarrollamos procesos de planificación que permiten la identificación de estrategias que generan altos impactos. Realizamos relevamiento de datos. Correlacionamos objetivos estratégicos y operativos, programas, proyectos y acciones, elaborando  planes maestros para alcanzar los objetivos.</p>
                    </li>
                    <li>
                        <h2>Desarrollo de acciones sociales territoriales</h2>
